...
export function Todos({ todos = [], fetchTodos, onLogout }) {
  ...
  const filteredTodos = todos.filter((todo) => {
    ...
    if (activeFilter === "completed") return isSameDay(due, today) && todo.completed;
    return true;
  });
    ...
    try {
      const response = await fetch(
        `https://to-do-app-616k.onrender.com/todos/${todo._id}`,
        {
          ...
          body: JSON.stringify({ completed: !todo.completed, priority: todo.priority }),
        }
      );
        ...
        <div className="avatar-wrapper" ref={menuRef}>
          ...
          {showMenu && (
            <div className="profile-dropdown">
              ...
              {/* Call onLogout prop from App.jsx */}
